    ...
    return (
      <>
        <div class="flex justify-center items-center h-screen w-full bg-gradient-to-r from-blue-500 to-purple-600">
         <div class="backdrop-blur-md w-1/2 bg-white bg-opacity-25 rounded-lg shadow-2x1 p-8 m-4">
           <h1 class="block w-full text-center text-gray-800 text-2x1 font-bold mb-6">
               Registrasi
